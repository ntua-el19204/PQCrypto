...
func verifyHandshakeSignature(sigType uint8, pubkey crypto.PublicKey, hashFunc crypto.Hash, signed, sig []byte) error {
	...
	case signatureFalcon512:
		...
		if !falcon512.Verify(pubKey, signed, sig) {
	...
	case signatureFalcon1024:
		...
		if !falcon1024.Verify(pubKey, signed, sig) {
			return errors.New("falcon1024 verification failure")
		}
...
func typeAndHashFromSignatureScheme(signatureAlgorithm SignatureScheme) (sigType uint8, hash crypto.Hash, err error) {
	...
	case Falcon512:
		sigType = signatureFalcon512
	case Falcon1024:
		sigType = signatureFalcon1024
	case Dilithium2:
		sigType = signatureDilithium2
	case Dilithium3:
